    ...
    <div className="w-full max-w-md">
      ...
      <div className="bg-[var(--card-bg)] border border-[var(--card-border)] rounded-2xl p-8">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-lg bg-white hover:bg-gray-100 text-black font-medium transition"
        >
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-4 bg-[var(--card-bg)] text-[var(--muted)]">or</span>
          </div>
        </div>
